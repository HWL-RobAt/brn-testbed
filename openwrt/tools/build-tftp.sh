...
case "$BUILD_ARCH" in
	...
	;;
    "wndr4300")
	mips-openwrt-linux-uclibc-objcopy -O binary -R .reginfo -R .notes -R .note -R .comment -R .mdebug -R .note.gnu.build-id -S vmlinux vmlinux-wndr4300

	$OPENWRT_STAGING_DIR/host/bin/lzma e ./vmlinux-wndr4300 -lc1 -lp2 -pb2 -d20 ./vmlinux-wndr4300.bin.lzma
	mkimage -A mips -O linux -T kernel -a 0x80060000 -C lzma -M 0x33373033 -e 0x80060000 -n 'MIPS OpenWrt Linux-3.10.49' -d ./vmlinux-wndr4300.bin.lzma ./vmlinux-wndr4300.uImage
	;;
esac
